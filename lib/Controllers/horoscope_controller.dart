        ...
        switch (selected_cardData["id"]) {
          ...
          case 9:
            finalPayload.value = {
              ...
              "Lon": getAstroPayload['Lon'],
              "Tz": getAstroPayload['Tz'],
              "Start_date": getAstroPayload['Date'],
              "Lang": getAstroPayload['Lang'],
              "service": getAstroPayload['service'],
            };
            break;
  ...
  var cardData = [
    {
      ...
      "icon": "assets/images/Planet_details.png",
      "isLongTerm": false
    },
    {
      "id": 2,
      "title": "Ascendant-Report",
      "icon": "assets/images/ascedent_reports.png",
      "isLongTerm": false
    },
    {
      "id": 3,
      "title": "Planet Report",
      "icon": "assets/images/planet_report.png",
      "isLongTerm": false
    },
    {
      "id": 4,
    ...
    },
    {
      ...
      "icon": "assets/images/divisional.png",
      "isLongTerm": false
    },
    {
      "id": 6,
    ...
    },
    {
      "id": 7,
      "title": "Ashtakvarga",
      "icon": "assets/images/ashtak.png",
      "isLongTerm": false
    },
    {
      "id": 8,
      "title": "Binnashtakvarga",
      "icon": "assets/images/binnash.png",
      "isLongTerm": false
    },
    {
      "id": 9,
      "title": "AI 12 Month Prediction",
      "icon": "assets/images/ai_twelve.png",
      "isLongTerm": false
      //  isLongTerm: true,
    },
    {
      ...
      "icon": "assets/images/planetary_aspects.png",
      "isLongTerm": false
    },
    {
      "id": 11,
      "title": "Planets in Houses",
      "icon": "assets/images/planets_in_house.png",
      "isLongTerm": false
    },
    {
      "id": 12,
      "title": "Western Planets",
      "icon": "assets/images/western_planets.png",
      "isLongTerm": false
    },
